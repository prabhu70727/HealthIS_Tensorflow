package com.example.prabhu.healthis_tensorflow;
...
public class SpeechActivity extends Activity {
    ...
    private static final String MODEL_FILENAME = "file:///android_asset/andoid_frozen_medium.pb";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Log.i(LOG_TAG,this.getAssets().toString());

        BufferedReader br = null;
        try {
            br = new BufferedReader(new InputStreamReader(this.getApplicationContext().getAssets().open(actualFilename)));
            String line;
                        ...
                        public void run() {
                            ...
                            if (!result.foundCommand.startsWith("_") && result.isNewCommand) {
                                ...
                                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                                    colorAnimation = ValueAnimator.ofArgb(0x00b3ccff, 0xffb3ccff, 0x00b3ccff);
                                }
